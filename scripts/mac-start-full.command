...
# macOS 一键启动：主窗口 + 悬浮窗（开发模式）
# 使用本地 Vite 开发服务器 + Electron 主进程
...
# 启动 Electron 应用（主窗口 + 悬浮窗）
echo "[INFO] 启动 Electron 应用（主窗口 + 悬浮窗）..."
cd "$PROJECT_DIR"
ELECTRON_RENDERER_URL="${RENDERER_URL}" APP_MODE="full" npx electron .